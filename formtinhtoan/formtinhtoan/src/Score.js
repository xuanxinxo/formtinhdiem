...
class Score extends Component {
    ...
    setXL = () => {
        if (this.state.avg <4.5 && this.state.avg >1) this.setState({ xl: "yếu" });
        if (this.state.avg < 6.5 && this.state.avg >=4.5 ) this.setState({ xl: "Trung  bình" });
        if (this.state.avg < 8 && this.state.avg >=6.5) this.setState({ xl: "Khá" });
        if (this.state.avg < 9 && this.state.avg >=8) this.setState({ xl: "Giỏi" });
        if (this.state.avg = 10 && this.state.avg >= 9) this.setState({ xl: "Xuất sắc" });
